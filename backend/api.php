...
class Api extends Config
{
    ...
    var $title_name;
    var $other_caption;
    var $other_gallerytype;
    var $other_title_name;
    ...
    public  function __construct()
    {
        ...
        $this->other_caption = $_POST['other_caption'];
        $this->other_gallerytype = $_POST['other_gallerytype'];
        $this->other_title_name = $_POST['other_title_name'];
    }
    ...
    public function updateParchitect()
    {
        ...
        if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($fileTmpName, $filePath)) {
                ...
                $query = "INSERT INTO images (img_caption,img_src,portfolio) VALUES ('" . mysqli_real_escape_string($this->getConnection(), $this->caption) . "',
    ...
    public function otherUploading()
    {
        // Check if the file was uploaded without errors
        if (isset($_FILES['file']) && $_FILES['file']['error'] === UPLOAD_ERR_OK) {
            // File information
            ...
            if (move_uploaded_file($fileTmpName, $filePath)) {
                ...
                // Prepare the SQL query
                $query = "INSERT INTO images (img_title,img_caption,img_src,portfolio) VALUES ('" . mysqli_real_escape_string($this->getConnection(),  $this->other_title_name) . "',
                                                                           '" . mysqli_real_escape_string($this->getConnection(), $this->other_caption) . "',
                                                                           '" . mysqli_real_escape_string($this->getConnection(), $fileUrl) . "',
                                                                           '" . mysqli_real_escape_string($this->getConnection(), $this->other_gallerytype) . "')";
...
if (isset($_POST['action']) && $_POST['action'] === 'other_uploadProc') {
    $main = new Api();
    $main->otherUploading();
}
